"""Test後再判断実験の workspace Tool。本番 Registry には接続しない。既存 fixture は使わない。"""
...
FIXTURE_SRC = (
    Path(__file__).resolve().parent / "fixtures" / "real_code_rejudgment"
)
...
def dump_result(result):
    return dump_tool_result_for_llm(result)
