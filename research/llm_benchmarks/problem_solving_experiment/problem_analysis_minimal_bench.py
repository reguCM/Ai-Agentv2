"""
Problem Analysis 完全最小 Prompt。分析項目・目的文を載せず Failure だけを渡す。
...
OUT_DIR = Path(
    "research/llm_benchmarks/problem_solving_experiment/results/problem_analysis_minimal"
)
...
def run_case(case):
    ...
    return {
        "experiment": "problem_analysis_minimal",
        "id": case["id"],
        ...
        "call_ok": call_ok,
        "notes": [
            "problem_analysis_minimal",
            "no_analysis_goals_in_prompt",
            "no_tools",
            "no_patch_requested",
        ],
        "observability": {
...
def main():
    ...
    run = {
        "experiment": "problem_analysis_minimal",
        "note": (
            "Minimal prompt Problem Analysis. No category list, no analysis goals. "
