#!/usr/bin/env python3
"""Run Web Research User-Facing Resolution & Source Presentation Proof."""
...
from ai_tool.web_research_user_facing_resolution_proof import run_web_research_user_facing_resolution_proof
from tools.system.config import get_llm_profile

RUN_ID = datetime.now().strftime("%Y%m%d_%H%M%S") + "_web_research_user_facing_resolution_proof"
...
def main() -> int:
    ...
    proc = subprocess.run(
        [
            ...
            "tests/ai_tool/project_audit/test_web_research_user_facing_resolution_proof.py",
            "-q",
            "--tb=no",
        ],
        cwd=_REPO,
