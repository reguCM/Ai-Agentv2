...
from ai_tool.goal_acceptance_eval import evaluate_goal_acceptance
...
def evaluate_goal_acceptance(
    ...
    """Test-runner overlay. Shared checks live in goal_acceptance_eval."""
    from ai_tool.goal_acceptance_eval import evaluate_goal_acceptance as _evaluate

    return _evaluate(test_case, record)
